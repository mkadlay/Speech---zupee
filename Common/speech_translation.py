...
def recognize_from_microphone():
    ...
    # speech_translation_config = speechsdk.translation.SpeechTranslationConfig(subscription="75cc940fe56b40368665c098ffe83f83", region="centralindia")
    ...
    if translation_recognition_result.reason == speechsdk.ResultReason.TranslatedSpeech:
        print("Transcription: {}".format(translation_recognition_result.translations[target_language]))
